...
1. Webブラウザで**Copilot Studio**（`https://copilotstudio.microsoft.com/`）を開き、必要に応じてサインインします。ウェルカムメッセージが表示された場合はスキップしてください。
    ...
    以下画面と表示が異なる場合があります。右上に表示されている **新しいエクスペリエンス** のスイッチをオフにして画面を切り替えてください。

    ![Copilot Studioのウェルカム画面のスクリーンショット](../media/Lab01_.JPG)
...
![トピックタブ（システムトピック一覧）のスクリーンショット](../media/Lab01_2.JPG)
...
1. **エージェントをテスト**ペインの**省略記号 ...** メニューから、**トピック間で追跡**を**オン**に切り替えます。
