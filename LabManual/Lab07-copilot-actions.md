...
1. **+ ツールを追加**を選びます。
    ...
    *2026年9月中旬時点の情報*
    ...
    Copilot Studioは新しいエクスペリエンスへの変更が行われていますが、フローについては以前のエクスペリエンスのままとなっています。**このページは従来のエクスペリエンスで開きます** と表示された場合は **新しいタブで開く** をクリックして開きます。ようこその表示がされる場合は **開始する** **スキップ** の順にボタンをクリックして進めます。

    ホーム画面に遷移した場合は、ワークフローの作成画面に進むためは再度この演習の1～5の手順を実行する必要があります。
