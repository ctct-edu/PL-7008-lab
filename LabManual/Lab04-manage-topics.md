...
1. **トリガー**の**ユーザーが語句を発声した時**の下にある**編集**を選択します。
    ...
    ![トピックトリガーフレーズペインのスクリーンショット](../media/topic-trigger-phrases.png)

1. **フレーズを追加**の下に`不動産の内見を予約したいです`と入力し、**+** アイコンを選択します。

1. **フレーズを追加**の下に`不動産の内見をスケジュールする`と入力し、**+** アイコンを選択します。

1. **フレーズを追加**の下に`不動産物件の見学を手配する`と入力し、**+** アイコンを選択します。

1. **フレーズを追加**の下に`家を見るアポイントメントを設定する`と入力し、**+** アイコンを選択します。

1. **フレーズを追加**の下に`物件の見学を計画する`と入力し、**+** アイコンを選択します。
